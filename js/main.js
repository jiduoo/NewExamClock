...
datearray = [
    [
        new date("测试考试 来自加零版考试时钟的初试", "测试科目", new Date(2022, 6, 15, 6 , 00), new Date(2022, 6, 15, 7 , 10)),
        new date("测试考试 来自加零版考试时钟的初试", "测试科目", new Date(2022, 6, 15, 8 , 10), new Date(2022, 6, 15, 9 , 20)),
        new date("测试考试 来自加零版考试时钟的初试", "测试科目", new Date(2022, 6, 15, 10, 20), new Date(2022, 6, 15, 11, 30)),
        new date("测试考试 来自加零版考试时钟的初试", "测试科目", new Date(2022, 6, 15, 15, 40), new Date(2022, 6, 15, 17, 50)),
        new date("测试考试 来自加零版考试时钟的初试", "测试科目", new Date(2022, 6, 15, 22, 50), new Date(2022, 6, 15, 23, 00)),

    ],
    [
        new date("测试考试 来自加零版考试时钟的初试", "测试科目", new Date(2022, 6, 15, 19, 00), new Date(2022, 6, 15, 23, 10)),
        new date("测试考试 来自加零版考试时钟的初试", "测试科目", new Date(2022, 6, 15, 22, 10), new Date(2022, 6, 15, 22, 20)),
        new date("测试考试 来自加零版考试时钟的初试", "测试科目", new Date(2022, 6, 15, 22, 20), new Date(2022, 6, 15, 22, 30)),
        new date("测试考试 来自加零版考试时钟的初试", "测试科目", new Date(2022, 6, 15, 22, 30), new Date(2022, 6, 15, 22, 40)),
        new date("测试考试 来自加零版考试时钟的初试", "测试科目", new Date(2022, 6, 15, 22, 40), new Date(2022, 6, 15, 22, 50)),
        new date("测试考试 来自加零版考试时钟的初试", "测试科目", new Date(2022, 6, 15, 22, 50), new Date(2022, 6, 15, 23, 00)),
    ...
    [
        new date("测试考试 来自加零版考试时钟的初试", "测试科目", new Date(2022, 6, 15, 7 , 00), new Date(2022, 6, 15, 9 , 10)),
        new date("测试考试 来自加零版考试时钟的初试", "测试科目", new Date(2022, 6, 15, 12, 10), new Date(2022, 6, 15, 14, 20)),
        new date("测试考试 来自加零版考试时钟的初试", "测试科目", new Date(2022, 6, 15, 15, 20), new Date(2022, 6, 15, 16, 30)),
        new date("测试考试 来自加零版考试时钟的初试", "测试科目", new Date(2022, 6, 15, 17, 30), new Date(2022, 6, 15, 18, 40)),
        new date("测试考试 来自加零版考试时钟的初试", "测试科目", new Date(2022, 6, 15, 19, 40), new Date(2022, 6, 15, 20, 50)),
        new date("测试考试 来自加零版考试时钟的初试", "测试科目", new Date(2022, 6, 15, 22, 50), new Date(2022, 6, 15, 23, 00)),
