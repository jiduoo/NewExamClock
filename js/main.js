...
datearray = [
    ...
    [
        new date("高二年级诊断性考试", "语文", new Date(2022, 7, 26, 7 , 40), new Date(2022, 7, 26, 10, 10)),
        new date("高二年级诊断性考试", "物理", new Date(2022, 7, 26, 10, 40), new Date(2022, 7, 26, 12, 20)),
        new date("高二年级诊断性考试", "英语", new Date(2022, 7, 26, 14, 20), new Date(2022, 7, 26, 16, 20)),
        new date("高二年级诊断性考试", "化学", new Date(2022, 7, 26, 16, 50), new Date(2022, 7, 26, 18, 30)),
        new date("高二年级诊断性考试", "生物", new Date(2022, 7, 27, 10, 20), new Date(2022, 7, 27, 12, 00)),
        new date("高二年级诊断性考试", "数学", new Date(2022, 7, 27, 7 , 50), new Date(2022, 7, 27, 9 , 50)),

    ],
     [
        new date("高二年级诊断性考试", "语文", new Date(2022, 7, 26, 7 , 40), new Date(2022, 7, 26, 10, 10)),
        new date("高二年级诊断性考试", "历史", new Date(2022, 7, 26, 10, 40), new Date(2022, 7, 26, 12, 20)),
        new date("高二年级诊断性考试", "英语", new Date(2022, 7, 26, 14, 20), new Date(2022, 7, 26, 16, 20)),
        new date("高二年级诊断性考试", "地理", new Date(2022, 7, 26, 16, 50), new Date(2022, 7, 26, 18, 30)),
        new date("高二年级诊断性考试", "政治", new Date(2022, 7, 27, 10, 20), new Date(2022, 7, 27, 12, 00)),
        new date("高二年级诊断性考试", "数学", new Date(2022, 7, 27, 7 , 50), new Date(2022, 7, 27, 9 , 50)),

    ],
    [
    new date("高三年级第一次月考", "数学", new Date(2022, 9, 8, 14, 00), new Date(2022, 9, 8, 16, 00)),
    new date("高三年级第一次月考", "英语", new Date(2022, 9, 8, 16, 30), new Date(2022, 9, 8, 18, 30)),
    new date("高三年级第一次月考", "语文", new Date(2022, 9, 9, 7 , 50), new Date(2022, 9, 9, 10, 20)),
    new date("高三年级第一次月考", "化学", new Date(2022, 9, 9, 10, 50), new Date(2022, 9, 9, 12, 30)),
    new date("高三年级第一次月考", "生物", new Date(2022, 9, 9, 14, 50), new Date(2022, 9, 9, 15, 40)),
    new date("高三年级第一次月考", "物理", new Date(2022, 9, 9, 16, 10), new Date(2022, 9, 9, 17, 50)),
],
 [
    new date("高三年级第一次月考", "数学", new Date(2022, 9, 8, 14, 00), new Date(2022, 9, 8, 16, 00)),
    new date("高三年级第一次月考", "英语", new Date(2022, 9, 8, 16, 30), new Date(2022, 9, 8, 18, 30)),
    new date("高三年级第一次月考", "语文", new Date(2022, 9, 9, 7 , 50), new Date(2022, 9, 9, 10, 20)),
    new date("高三年级第一次月考", "地理", new Date(2022, 9, 9, 10, 50), new Date(2022, 9, 9, 12, 30)),
    new date("高三年级第一次月考", "历史", new Date(2022, 9, 9, 14, 50), new Date(2022, 9, 9, 15, 40)),
    new date("高三年级第一次月考", "政治", new Date(2022, 9, 9, 16, 10), new Date(2022, 9, 9, 17, 50)),
